...
namespace PhotonTrafficLogger
{
    public class PhotonTrafficLoggerEditorWindow : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            Debug.Log(
                $"[PhotonTrafficLoggerEditorWindow] Loaded settings - Enabled: {_settings.Enabled}, ConsoleOutput: {_settings.ConsoleOutput}, LogOutputPath: {_settings.LogOutputPath}, LogFileLimit: {_settings.LogFileLimit}");
        }
        ...
        private void OnGUI()
        {
            ...
            if (GUI.changed)
            {
                ...
                Debug.Log(
                    $"[PhotonTrafficLoggerEditorWindow] Saved settings - Enabled: {_settings.Enabled}, ConsoleOutput: {_settings.ConsoleOutput}, LogOutputPath: {_settings.LogOutputPath}, LogFileLimit: {_settings.LogFileLimit}");
            }
        }
